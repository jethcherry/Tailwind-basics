...
>     {:tailwind, "~> 0.1", runtime: Mix.env() == :dev}
  ...
  end`}},{title:"Configure the Tailwind plugin",body:()=>(0,n.jsxs)("p",{children:["In your ",(0,n.jsx)("code",{children:"config.exs"})," file you can set which version of Tailwind CSS you want to use, the path to your Tailwind config, and customize your asset paths."]}),code:{name:"config.exs",lang:"elixir",code:`config :tailwind, version: "${i(88887).i}", default: [
  args: ~w(
